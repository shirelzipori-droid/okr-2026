...
SC_APPROVAL: dict[str, str] = {
    ...
    "OFL / order (ILS)": f"✅ verified by user · {OFL_WM_UE_NOTE}",
    ...
    "Avg Units per Order": "✅ verified by user · Golden Growth 106613 · MART SOLD_UNITS ÷ TOTAL_ORDERS (ISR WM)",
    ...
    "Available Product Selection": "✅ verified by user · Golden Selection 106615 · Available Selection (MART per active WM store)",
