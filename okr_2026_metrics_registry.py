...
OKR_METRICS: list[MetricRow] = [
    ...
    {"name": "New Stores", "leader": "Exp", "partner": "", "source": "manual", "workflow": "yearly"},
    {"name": "Expansion", "leader": "Exp", "partner": "", "source": "manual", "workflow": "yearly"},
    {"name": "Relocation", "leader": "Exp", "partner": "", "source": "manual", "workflow": "yearly"},
    ...
    {"name": "Avg Units per Order", "leader": "CAT & Content", "partner": "Marketing", "source": "snowflake", "workflow": "auto"},
    ...
    {"name": "Awareness", "leader": "Marketing", "partner": "", "source": "manual", "workflow": "yearly"},
    {"name": "New special vendors or categories", "leader": "CAT & Content", "partner": "", "source": "manual", "workflow": "yearly"},
    {"name": "Available Product Selection", "leader": "CAT & Content", "partner": "", "source": "snowflake", "workflow": "auto"},
    ...
    {"name": "IDP & HQ training", "leader": "HR", "partner": "", "source": "manual", "workflow": "yearly"},
    {"name": "Internal Mobility", "leader": "HR", "partner": "", "source": "manual", "workflow": "yearly"},
    {"name": "OPS Training", "leader": "HR", "partner": "", "source": "manual", "workflow": "yearly"},
