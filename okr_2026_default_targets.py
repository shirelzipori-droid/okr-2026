...
OKR_2026_TARGET_BY_METRIC: dict[str, list[float | None]] = {
    ...
    "Ftu Sessions": [179, 179, 200, 215, 215, 215, 244, 244, 244, 268, 268, 268],
    # Monthly FTU CVR not legible in export — values approximate annual 17.8%.
    "Ftu Conversion": [18.5, 17.8, 17.0, 17.2, 18.0, 17.5, 17.8, 17.9, 17.5, 18.1, 17.6, 17.8],
    "Returning User Sessions": [740, 760, 840, 917, 917, 917, 1042, 1042, 1042, 1133, 1133, 1133],
    "Returning User Conversion": [40.5, 40.4, 40.8, 37.8, 41.7, 38.5, 42.4, 42.8, 38.6, 39.8, 41.8, 40.9],
